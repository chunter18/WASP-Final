...
void Adafruit_INA219::setCalibration_16V_180mA_WASP(){
	ina219_calValue = 33851;
	ina219_currentDivider_mA = 181.81;  // Current LSB = 50uA per bit (1000/50 = 20)
	ina219_powerMultiplier_mW = 0.11;     // Power LSB = 1mW per bit
	uint16_t config = INA219_CONFIG_BVOLTAGERANGE_16V |
                    INA219_CONFIG_GAIN_1_40MV |
                    INA219_CONFIG_BADCRES_12BIT |
                    INA219_CONFIG_SADCRES_12BIT_1S_532US |
...
void Adafruit_INA219::setCalibration_16V_700mA_WASP() {

  ina219_calValue = 8095;
  // Set multipliers to convert raw current/power values
  ina219_currentDivider_mA = 43.48;  
  ina219_powerMultiplier_mW = 0.46;    
...
void Adafruit_INA219::setCalibration_16V_1A_WASP(void){
	ina219_calValue = 4654;
	ina219_currentDivider_mA = 25;  
	ina219_powerMultiplier_mW = 0.8;     
	uint16_t config = INA219_CONFIG_BVOLTAGERANGE_16V |
                    INA219_CONFIG_GAIN_8_320MV |
                    INA219_CONFIG_BADCRES_12BIT |
                    INA219_CONFIG_SADCRES_12BIT_1S_532US |
...
void Adafruit_INA219::setCalibration_16V_1_45_A_WASP(void){
	ina219_calValue = 4137;
	ina219_currentDivider_mA = 22.2;  
	ina219_powerMultiplier_mW = 0.9;     
	uint16_t config = INA219_CONFIG_BVOLTAGERANGE_16V |
                    INA219_CONFIG_GAIN_8_320MV |
                    INA219_CONFIG_BADCRES_12BIT |
                    INA219_CONFIG_SADCRES_12BIT_1S_532US |
